...
namespace ng {
	...
	void SDLScreen::Rect(int x, int y, int w, int h, GLuint color) {
		glUseProgram(shader);
		glBindVertexArray(vao);
	...
	void SDLScreen::FillCircle(int x, int y, float radius, GLuint color) {
		glUseProgram(shader);
		glBindVertexArray(vao);
	...
	void SDLScreen::Circle(int x, int y, float radius, GLuint color) {
		glUseProgram(shader);
		glBindVertexArray(vao);
	...
	void SDLScreen::DeleteTexture(GLuint textureID) {
		if(glIsTexture(textureID)) {
			glDeleteTextures(1, &textureID);
		}
	}

	void SDLScreen::Line(int xA, int yA, int xB, int yB, GLuint color) {
		glUseProgram(shader);
		glBindVertexArray(vao);
	...
	void SDLScreen::VLine(int x1, int y1, int y2, GLuint color) {
